...
class MovieFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $ironManTwo = new Movie();
        $ironManTwo->setTitle('Iron man 2');
        $ironManTwo->setRating(9.4);
        $ironManTwo->setImage('https://cdn.pixabay.com/photo/2017/04/26/14/39/welding-2262745_1280.jpg');
        $ironManTwo->setDescription(
            'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
            ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in
            voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident
        ...
        $ironManTwo->addActor($this->getReference('actor_3'));

        $manager->persist($ironManTwo);
